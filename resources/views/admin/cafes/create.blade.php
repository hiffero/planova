...
<head>
    ...
    <title>Tambah Cafe — PLANOVA Admin</title>
        ...
        <header class="topbar">
            <div style="display:flex;align-items:center;gap:14px;">
                ...
                <div class="topbar-left">
                    <h1>Tambah Cafe</h1>
                    <p>Daftarkan cafe partner baru ke sistem</p>
                </div>
            </div>
        ...
        <main class="page-body">
            <div class="form-wrapper">
                ...
                <div class="info-box">
                    ...
                    <span>Gunakan foto berkualitas tinggi untuk menampilkan cafe dengan lebih menarik. Format yang didukung: JPG, PNG (maksimal 2MB).</span>
                </div>
                ...
                <form action="{{ route('admin.cafes.store') }}" method="POST"
                    ...
                    <div class="section-card">
                        ...
                        <div class="section-head">
                            <div class="section-head-icon"><i class="bi bi-building-add"></i></div>
                            <h2>Informasi Cafe Baru</h2>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-upload-zone" id="uploadZone">
                                    ...
                                    <input type="file" name="image" id="image"
                                           ...
                                           aria-label="Upload foto cafe">
                                </div>
                                <div class="file-preview" id="filePreview">
                                    <img id="previewImg" src="" alt="Preview">
                                    <span class="file-preview-name" id="fileName"></span>
                                    <button type="button" class="file-remove" id="removeFile" title="Hapus">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn-submit" id="submitBtn">
                                ...
                                <span id="btnText">Simpan Cafe</span>
                            </button>
                        </div>
...
<script>
    ...
    if (description) {
        description.addEventListener('input', function() {
            this.style.borderColor = (this.value.length > 0 && this.value.length < 20)
                ? 'var(--amber)' : '';
        });
    }
</script>
